...
import { getAll, getOne, create, update, remove, mergeProducts, toggleCatalog } from '../controllers/products.controller'
...
router.patch('/:id/toggle-catalog', requireAdmin, asyncHandler(toggleCatalog))
